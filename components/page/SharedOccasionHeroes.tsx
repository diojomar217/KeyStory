...
function SafeHeroImage({
  ...
  return (
    <img
      src={src}
      alt={alt}
      className={`absolute inset-0 h-full w-full ${className} [transform:translateZ(0)] [backface-visibility:hidden]`}
          ...
          <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col justify-between px-6 py-10 md:px-10 lg:px-14">
            ...
            <div className="grid items-end gap-10 lg:grid-cols-[minmax(0,1.15fr)_340px]">
              <div className="max-w-4xl">
                ...
                <h1 className={`${styles.heading} mb-5 max-w-4xl text-5xl font-semibold leading-[0.95] tracking-tight md:text-7xl lg:text-8xl`}>
                  {headlineText}
                </h1>
                <p className="mb-4 max-w-2xl text-base font-light tracking-[0.16em] text-white/70 md:text-lg uppercase">
              ...
              <div ref={premiumCardRef} className="rounded-[2rem] border border-white/15 bg-black/25 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl">
                ...
                <div className="space-y-4">
                  {heroHighlights.map((item) => (
                    <div key={`${item.label}-ceremony`} className="rounded-2xl border border-white/10 bg-white/5 p-4">
      ...
      return (
        <section className={`relative min-h-screen overflow-hidden ${styles.heroBg}`}>
          ...
          <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-6 py-16 text-center md:px-10">
            ...
            <div ref={premiumImageRef} className={`relative mt-8 h-44 w-44 overflow-hidden rounded-[2rem] border border-white/40 bg-white/30 p-2 shadow-[0_24px_80px_rgba(244,114,182,0.28)] backdrop-blur-md transition-all duration-700 md:h-56 md:w-56 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <h1 className={`${styles.heading} mt-8 max-w-4xl text-5xl font-black leading-[0.94] tracking-tight ${styles.text} md:text-7xl`}>
              {headlineText}
            </h1>
        ...
        <section className={`relative min-h-screen overflow-hidden ${styles.heroBg}`}>
          ...
          <div className="relative z-10 mx-auto grid min-h-screen max-w-7xl items-center gap-12 px-6 py-14 md:px-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h1 className={`${styles.heading} mt-8 max-w-3xl text-5xl font-bold leading-[0.96] ${styles.text} md:text-7xl`}>
                {displayHeadline}
              </h1>
              ...
              <div className={`mt-6 max-w-2xl rounded-[1.75rem] border ${styles.cardBorder} ${styles.card} p-6 shadow-xl`}>
                <p className={`text-lg leading-8 ${styles.text} opacity-85`}>
                  {supportingNarrative}
                </p>
              </div>
              <div className="mt-8">{sharedActions}</div>
            ...
            <div className="relative min-h-[480px]">
              <div ref={premiumImageRef} className="absolute left-0 top-10 h-64 w-52 rotate-[-6deg] rounded-[1.75rem] border border-white/50 bg-white p-3 shadow-2xl md:h-72 md:w-56">
                <div className="relative h-full w-full overflow-hidden rounded-[1.25rem]">
                  <SafeHeroImage src={heroImage} alt={displayHeadline} className="object-cover" priority />
                </div>
              </div>
              <div className={`absolute right-0 top-0 w-64 rotate-[7deg] rounded-[1.75rem] border ${styles.cardBorder} bg-white/90 p-5 shadow-xl backdrop-blur-sm hidden md:block`}>
              ...
              <div ref={premiumCardRef} className={`absolute bottom-0 right-8 w-72 -rotate-[4deg] rounded-[1.75rem] border ${styles.cardBorder} ${styles.glassCard} p-5 shadow-2xl hidden md:block`}>
                <div className={`mb-4 text-xs font-semibold uppercase tracking-[0.24em] ${styles.textMuted}`}>Memory Snippets</div>
                <div className="space-y-3">
                  {heroHighlights.map((item) => (
                    <div key={`${item.label}-scrapbook`} className="rounded-2xl bg-white/55 px-4 py-3">
      ...
      return (
        <section className="relative min-h-screen overflow-hidden bg-gradient-to-b from-slate-900 via-zinc-900 to-black text-white">
          ...
          <div className="relative z-10 mx-auto flex min-h-screen max-w-4xl flex-col items-center justify-center px-6 py-16 text-center md:px-10">
            {sharedEyebrow}
            <div ref={premiumImageRef} className="relative mt-10 h-56 w-48 overflow-hidden rounded-[2rem] border border-white/15 bg-white/5 p-2 shadow-[0_24px_80px_rgba(0,0,0,0.45)] md:h-72 md:w-60">
              <SafeHeroImage src={heroImage} alt={displayHeadline} className="rounded-[1.5rem] object-cover opacity-95" priority />
            </div>
            <h1 className={`${styles.heading} mt-10 text-5xl font-semibold leading-tight md:text-7xl`}>
              {displayHeadline}
            </h1>
        ...
        <section className="relative min-h-screen overflow-hidden bg-[linear-gradient(135deg,#f8fafc_0%,#eff6ff_42%,#e2e8f0_100%)]">
          ...
          <div className="relative z-10 mx-auto grid min-h-screen max-w-7xl items-center gap-10 px-6 py-14 md:px-10 lg:grid-cols-[1fr_1.1fr]">
            <div className="order-2 lg:order-1">
              ...
              <h1 className={`mt-8 max-w-3xl text-5xl font-black leading-[0.94] tracking-tight text-slate-900 md:text-7xl ${styles.heading}`}>
                {displayHeadline}
              </h1>
            ...
            <div className="order-1 lg:order-2">
              <div ref={premiumImageRef} className="relative overflow-hidden rounded-[2.2rem] border border-white/70 bg-white p-3 shadow-[0_24px_80px_rgba(15,23,42,0.14)]">
        ...
        <section className={`relative min-h-screen overflow-hidden ${styles.heroBg}`}>
          ...
          <div className="relative z-10 mx-auto grid min-h-screen max-w-7xl items-center gap-10 px-6 py-12 md:px-10 lg:grid-cols-[1.18fr_0.82fr] lg:gap-12">
            <div className="max-w-3xl">
              {sharedEyebrow}
              <h1 className={`${styles.heading} mt-8 max-w-4xl text-5xl font-semibold leading-[0.92] tracking-tight ${styles.text} md:text-7xl xl:text-8xl`}>
