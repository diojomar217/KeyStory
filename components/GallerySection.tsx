    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
      {photos.map((photo, idx) => (
        <div
          ...
          className={`relative aspect-square rounded-xl overflow-hidden shadow-lg ${styles.cardBorder} border-2 hover:scale-105 transition-transform duration-300 cursor-pointer group`}
        >
          <Image
            src={photo}
            alt={`Photo ${idx + 1}`}
